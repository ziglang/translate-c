...
// pub const MAY_NEED_PROMOTION_1 = __helpers.promoteIntLiteral(c_int, 10241024, .decimal);
// pub const MAY_NEED_PROMOTION_2 = __helpers.promoteIntLiteral(c_long, 307230723072, .decimal);
// pub const MAY_NEED_PROMOTION_3 = __helpers.promoteIntLiteral(c_ulong, 819281928192, .decimal);
// pub const MAY_NEED_PROMOTION_HEX = __helpers.promoteIntLiteral(c_int, 0x80000000, .hex);
// pub const MAY_NEED_PROMOTION_OCT = __helpers.promoteIntLiteral(c_int, 0o20000000000, .octal);
